...
if(isset($_POST["btncreate"])) {
    ...
    $contactNumbers = $_POST['txtcontact'];
    ...
    if(!in_array($file_type, $allowed)) {
        ...
        move_uploaded_file($_FILES["avatar"]["tmp_name"], "../uploadImage/Skills/" . $_FILES["avatar"]["name"]);
        $location = "uploadImage/Skills/" . $_FILES["avatar"]["name"];

        // Add skills details
        $sql = 'INSERT INTO tblskill(Name, Skills, ContactNumbers, Image) VALUES(:name, :skills, :contactNumbers, :image)';
        ...
        if ($statement) {
            ...
            $_SESSION['error'] = 'Problem Adding Skill';
        }
    }
}
?>
...
<div class="wrapper">
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <div class="content-wrapper">
    ...
    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtname'])) echo $_POST['txtname']; ?>" placeholder="Enter Name">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Skills</label>
    <input type="text" class="form-control" name="txtskills" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtskills'])) echo $_POST['txtskills']; ?>" placeholder="Enter Skills">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Contact Numbers</label>
    <input type="tel" class="form-control" name="txtcontact" id="txtcontact" size="77" value="<?php if (isset($_POST['txtcontact'])) echo $_POST['txtcontact']; ?>" placeholder="Enter Contact Numbers">
</div>
<div class="form-group">
    ...
    <p class="text-center">
        <img src="../<?php echo $admin_photo; ?>" alt="user image" width="178" height="154" id="logo-img">
                ...
                <div class="card-footer">
                  <button type="submit" name="btncreate" class="btn btn-primary">Create Skill</button>
                </div>
              </form>
            </div>
