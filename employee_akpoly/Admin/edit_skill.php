            ...
            <tr>
              <td width="1090" height="184"><div class="card">
                ...
                <div class="card-footer">
                  <a class="btn btn-primary" href="add-skill.php">Add Skill</a>
                ...
                <th><div align="center"><span class="style1">Image</span></div></th>
              <th><div align="center"><span class="style1">Name</span></div></th>
              <th><div align="center"><span class="style1">Skills</span></div></th>
              <th><div align="center"><span class="style1">Contact Number</span></div></th>
              <th><div align="center"><span class="style1">Action</span></div></th>
                      ...
                      <tbody>
    <?php
    $data = $dbh->query("SELECT *  FROM tblskill ORDER BY id DESC")->fetchAll();
    $cnt = 1;
    foreach ($data as $row) {
    ?>
    <tr class="gradeX">
        <td><div align="center" class="style2"><?php echo $cnt;  ?></div></td>
        <td><div align="center" class="style2"><span class="controls"><img src="../<?php echo $row['Image'];?>"  width="50" height="43" border="2"/></span></div></td>
        <td><div align="center" class="style2"><?php echo $row['name'];  ?></div></td>
        <td><div align="center" class="style2"><?php echo $row['skills'];  ?></div></td>
        <td><div align="center" class="style2"><?php echo $row['ContactNumbers'];  ?></div></td>
        <td>
            <div align="center">
                <a href="delete-skill.php?id=<?php echo $row['id'];?>" onClick="return deldata(<?php echo $row['id']; ?>);">Delete </a>
            </div>
        </td>
    </tr>
    <?php $cnt = $cnt + 1;} ?>
