...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
        <a href="add-skill.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
        <p>Add Skill Service</p>
      </a>
    </li>


    <li class="nav-item">
      <a href="edit_skill.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
        <p>Skill Service Record</p>
      </a>
    </li>
  </ul>
</li>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      <a href="list-announcements.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
