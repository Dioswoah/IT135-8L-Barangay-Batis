...
if (isset($_POST["btnedit"])) {
    ...
    if (!empty($_FILES['userImage']['tmp_name']) && is_uploaded_file($_FILES['userImage']['tmp_name'])) {
        ...
        // Set error message if no file was selected
        $_SESSION['error'] = 'No file selected. Please choose a file to upload.';
    }
}
?> 
...
$row= mysqli_fetch_array($result);
    ...
    <div class="row">
        <div class="col-sm-6 b-r">
            <h3 class="m-t-none m-b">Edit Employee Photo</h3>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <p class="text-center">
                        <img src="../<?php echo $rowaccess['photo']; ?>" alt="user image" width="166" height="147" id="logo-img">
                    </p>
                    <p class="text-center">
                    ...
                    <?php if(isset($_SESSION['error']) && !empty($_SESSION['error'])): ?>
                        <p class="text-center text-danger"><?php echo $_SESSION['error']; ?></p>
                    <?php endif; ?>
                </div>
                <div class="form-group">
