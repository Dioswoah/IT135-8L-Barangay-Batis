                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $fullname ;?></strong></h4>
                                 <h5><strong>User ID</strong>: <?php echo $employeeID ;?></h5>
                            ...
                            <div>
                                <div class="feed-activity-list">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Barangay :</strong>                    <?php echo $rowaccess['barangay'];   ?>  <br>
                                        </div>
                                    </div>
                                    </div><div class="feed-element">
                                        <a href="#" class="pull-left">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Zip Code :</strong>                    <?php echo $rowaccess['zip_code'];   ?>  <br>
                                        </div>
                                    </div>
