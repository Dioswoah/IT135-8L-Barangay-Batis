...
if (isset($_POST["btnedit"])) {
    $sql = " update tblemployee set fullname='".$_POST['txtfullname']."', sex='".$_POST['cmdsex']."', dob='".$_POST['txtdob']."', phone='".$_POST['txtphone']."', address='".$_POST['txtaddress']."', barangay='".$_POST['barangay']."', zip_code='".$_POST['zip_code']."' WHERE email='$email'";
                                    ...
                                    <div class="col-sm-6 b-r">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" size="77" name="barangay" value="<?php echo $row['barangay'];   ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Zipcode</label> 
                                                <input type="text" size="77" name="zip_code" value="<?php echo $row['zip_code'];   ?>" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Email</label> 
                                                <input type="text" size="77" name="email" value="<?php echo $row['email'];   ?>" class="form-control">
                                            </div>
