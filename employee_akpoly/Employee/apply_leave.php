            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Permit Application </strong></li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r">
                              <h3 class="m-t-none m-b">Permit Application </h3>
                                <form role="form" method="POST">
									...
									<div class="form-group"><strong>
                                    <label>Type of Permit</label></strong>
                                    <select class="form-control" id="cmdreason" name="cmdreason" required>
                                                    <option value="">Select Request</option>
                                                    <option value="Barangay Clearance">Barangay Clearance</option>
                                                    <option value="Certificate of Residency">Certificate of Residency</option>
                                                    <option value="Certificate of Indegency">Certificate of Indegency</option>
