...
if(isset($_POST['btnlogin'])) {
    ...
    $sql = "SELECT * FROM tblemployee WHERE email=? AND password=? AND status=?";
    $statement = $conn->prepare($sql);
    $statement->bind_param("ssi", $email, $password, $status);
    $statement->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: ../Employee/index.php"); // Redirect to the desired page
                ...
                <div class="form-holder">
                    ...
                    <div class="form-content h-100">
                        <div class="form-items card" style="z-index:100">
                            <img class="logo-size card-img-top w-auto" src="../image/brgylogo.jpg" height="100" alt="">
                            <div class="card-header d-flex flex-wrap">
                                <a href="../index.php" style="z-index: 3;" class="btn p-2 btn-outline-primary mr-auto d-inline-flex align-items-center"><i class="fas fa-home fa-2x" title="home"></i></a><h2 class="mr-auto">San Juaneños Login</h2><div class="ml-auto"></div>
                            </div>
                            <div class="card-body">
