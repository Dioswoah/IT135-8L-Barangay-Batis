...
if(isset($_POST["btnsubmit"])) {
    ...
    // Set default status to '1' (assuming '1' means active)
    $status = 1;

    $sql = 'INSERT INTO tblemployee(employeeID, fullname, password, sex, email, dob, phone, address, qualification, dept, zip_code, date_appointment, barangay, gross_pay, status, leave_status, photo) VALUES(:employeeID, :fullname, :password, :sex, :email, :dob, :phone, :address, :qualification, :dept, :zip_code, :date_appointment, :barangay, :gross_pay, :status, :leave_status, :photo)';
    $statement = $dbh->prepare($sql);

    // Check if the 'bday' field is set and not empty
    $dob = (!empty($_POST['txtbday'])) ? $_POST['txtbday'] : '0000-00-00'; // Set a default value for 'dob'

    $statement->execute([
        ':employeeID' => $employeeID,
        ':fullname' => $_POST['txtfullname'],
        ':password' => $_POST['txtpassword'], // Store password as-is
        ':sex' => $_POST['cmdsex'],
        ...
        ':qualification' => '',
        ':dept' => '',
        ':zip_code' => $_POST['cmdzipcode'],
        ':date_appointment' => '',
        ':barangay' => $_POST['cmdbarangay'],
        ':gross_pay' => '',
                ...
                <div class="form-content" style="max-height: unset;">
                    ...
                    <img src="../image/brgylogo.jpg" alt="" class="logo-light" height="81">
                        ...
                        <div class="card-header d-flex flex-wrap">
                            ...
                            <h4 class="mr-auto my-auto text-center">San Juaneños Registration</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            ...
                                            <select class="form-control" required data-validation-required-message="Select Employee Department" data-val="true" data-val-required="The Employee Department field is required." id="cmdzipcode" name="cmdzipcode">
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            <div class="controls">
                                            <select class="form-control" required data-validation-required-message="Select Emplooyee Type" data-val="true" data-val-required="The Employee Type field is required." id="cmdbarangay" name="cmdbarangay">
                                        ...
                                        <div class="controls">
                                            <b>Birthday:</b>
                                            <input type="date" name="txtbday" id="bday" class="form-control" required>
                                            <span id="bday-error" class="text-danger"></span>
                                        </div>
                                        </div>

                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            <div class="controls">
                                                <input class="form-control" type="text" placeholder="Address" required data-validation-required-message="Mobile Number is required" data-val="true" data-val-required="The Phone field is required." id="txtaddress" name="txtaddress" value="">
                                                <span id="error-msg" class="hide"></span>
                                            </div>
                                        </div>
...
<script>
    document.getElementById('bday').addEventListener('change', function() {
        ...
        if (selectedDate > currentDate) {
            document.getElementById('bday-error').textContent = 'Selected date cannot be beyond current date.';
            this.value = ''; // Clear the input
        } else {
            document.getElementById('bday-error').textContent = '';
        }
    });
</script>
